...
public class WorkerChildOrderAdapter extends RecyclerView.Adapter<WorkerChildOrderAdapter.MyViewHolder> {
    ...
    public WorkerChildOrderAdapter(Context context, ArrayList<DataProduct> ChildOrderList) {
    ...
    @Override
    public WorkerChildOrderAdapter.MyViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View itemView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.layout_order_simple_item_for_worker, viewGroup, false);


        WorkerChildOrderAdapter.MyViewHolder adapter = new MyViewHolder(itemView);
        return adapter;
